...
async function main() {
  ...
  // Anda bisa menambahkan setting lain di sini jika perlu
  // Contoh:
  // const maxInstallments = await prisma.applicationSetting.upsert({
  //   where: { key: 'MAX_ALLOWED_INSTALLMENTS' },
  //   update: {},
  //   create: {
  //     key: 'MAX_ALLOWED_INSTALLMENTS',
  //     value: '6',
  //     description: 'Maximum number of installments allowed for payment.',
  //     dataType: 'NUMBER',
  //   },
  // });
  // console.log(`Created/ensured setting: ${maxInstallments.key} with value ${maxInstallments.value}`);
